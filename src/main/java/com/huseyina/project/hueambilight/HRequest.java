...
public class HRequest {
  ...
  private static JsonObject extractJObject(String response) // make the response message to a
                                                            // JsonObject
  {
  ...
  public static String responseCheck(JsonObject response) // check what the type from the response
                                                          // message
  {
    String result;
